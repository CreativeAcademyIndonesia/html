				...
				<div class="container">
					...
					<div class="header-row">
                      ...
                      <ul class="sub-menu-container">
                        ...
                        <li class="menu-item current"><a class="menu-link" href="rawat-jalan.php">
                            <div>Rawat Jalan</div>
                        </a></li>
				...
				<div class="container">
					<div class="row justify-content-center mb-5">
						<div class="col-xl-6 col-lg-8 text-center">
							<h3 class="h1 fw-bold mb-3">Rawat Jalan</h3>
						</div>
					</div>
							
					<div class="row mb-5">
						<div class="col-xl-6 col-lg-8">
							<span>Jumlah Kunjungan Rawat jalan = 133.019 kunjungan.
<br><br>
10 Penyakit terbanyak di rawat jalan:</span>
						</div>
					</div>
					...
					<div class="table-responsive">
						<table id="datatable1" class="table table-striped table-bordered" cellspacing="0" width="100%">
							...
							<tbody>
								...
								<tr>
									<td>2.</td>
									<td>Penyakit Jantung Iskemik</td>
									<td>1.022</td>
								</tr>
								<tr>
									<td>3.</td>
