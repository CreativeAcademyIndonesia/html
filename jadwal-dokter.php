							...
							<ul class="menu-container">
								...
								<li class="menu-item"><a class="menu-link" href="#">
									...
									<ul class="sub-menu-container">
										...
										<li class="menu-item"><a class="menu-link" href="visi-misi.php">
												<div>Visi & Misi</div>
											</a></li>
								...
								<li class="menu-item current"><a class="menu-link" href="#">
									...
									<ul class="sub-menu-container">
										...
										<li class="menu-item"><a class="menu-link" href="dokter-spesialis.php">
												<div>Dokter Spesialis</div>
											</a></li>

										<li class="menu-item current"><a class="menu-link" href="jadwal-dokter.php">
												<div>Jadwal Dokter</div>
											</a></li>

										<li class="menu-item"><a class="menu-link" href="kegiatan.php">
												<div>Kegiatan</div>
											</a></li>
			...
			<div class="container">
				<div class="page-title-row">
					...
					<div class="page-title-content">
						<h1>Jadwal Dokter</h1>
						<span>Visi Misi RSUD Kabupaten Poso</span>
					</div>
				...
				<div class="container">
					<div class="row justify-content-center mb-5">
						<div class="col-xl-6 col-lg-8 text-center">
							<h3 class="h1 fw-bold mb-3">Jadwal Dokter</h3>
						</div>
					</div>
						...
						<table id="datatable1" class="table table-striped table-bordered" cellspacing="0" width="100%">
							<thead>
								<tr>
									...
									<th>JADWAL</th>
									<th>NAMA DOKTER</th>
									<th>JAM PRAKTEK POLIK</th>
									<th>JUMLAH STAF PERAWAT</th>
							...
							<tbody>
								<tr>
									...
									<td>Saraf</td>
									<td>TIAP HARI</td>
									<td>1. dr. Isnaniah, Sp. S<br>2. dr. Jenny Sampe, Sp. S<br>3. dr. Ruth M. Thois M.Kes (Asisten)</td>
									<td>08:00 - 12:00</td>
									<td>1. Nyoman Teresia<br>2. Masida S.Kep<br>3. Haswinda, Amd.Kep</td>
								</tr>
								<tr>
									<td>2.</td>
									<td>Saraf</td>
