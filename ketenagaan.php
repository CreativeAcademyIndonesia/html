                          ...
                          <nav class="primary-menu style-3 menu-spacing-margin">
                             ...
                             <ul class="menu-container">
                              ...
                              <li class="menu-item current"><a class="menu-link" href="#">
                                ...
                                <ul class="sub-menu-container">
                                  <li class="menu-item current"><a class="menu-link" href="ketenagaan.php">
                                    <div>Ketenagaan</div>
                                </a></li>
				...
				<div class="page-title-row">
					...
					<nav aria-label="breadcrumb">
						...
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active" aria-current="page">Ketenagaan</li>
						</ol>
					</nav>
				</div>
				...
				<div class="container">
					<div class="row justify-content-center mb-5">
						<div class="col-xl-6 col-lg-8 text-center">
							<h3 class="h1 fw-bold mb-3">STRUKTUR KETENAGAAN</h3>
						</div>
					</div>
<center>
...
<h2 class="elementor-heading-title elementor-size-medium elementor-inline-editing pen" contenteditable="true" data-elementor-setting-key="title" data-pen-placeholder="Ketik di Sini..."><span class="JsGRdQ">Note</span>&ZeroWidthSpace;</h2>
