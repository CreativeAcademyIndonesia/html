                ...
                <div class="container">
                   ...
                   <div class="header-row">
                      ...
                      <ul class="sub-menu-container">
                        ...
                        <li class="menu-item current"><a class="menu-link" href="igd-24jam.php">
                            <div>IGD (24 Jam)</div>
                        </a></li>
				...
				<div class="page-title-row">
					...
					<nav aria-label="breadcrumb">
						...
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active" aria-current="page">IGD (24 Jam)</li>
						</ol>
					</nav>
				</div>
				...
				<div class="container">
					<div class="row justify-content-center mb-5">
						<div class="col-xl-6 col-lg-8 text-center">
							<h3 class="h1 fw-bold mb-3">IGD 24 Jam</h3>
						</div>
					</div>
<center>
<img src="images/bagan1.png">
</center>
...
<h2 class="elementor-heading-title elementor-size-medium elementor-inline-editing pen" contenteditable="true" data-elementor-setting-key="title" data-pen-placeholder="Ketik di Sini..."><span class="JsGRdQ">IGD 24 JAM</span>&ZeroWidthSpace;</h2>
<p><strong>Selama 24 jam Instalasi Gawat Darurat selalu siap melayani dalam Kasus Kegawat daruratan yang didukung dengan peralatan yang memadai serta Dokter dan Perawat yang Profesional, dengan Keahlian dan Keterampilan Dalam penanganan Gawat Darurat sesuai dengan pelatihan PPGD, ATLS. (Advance Trauma Life Support)</strong></p>
<ol>
