...
<body>
	...
	<div id="wrapper">
                             ...
                             <ul class="menu-container">
                              ...
                              <li class="menu-item current"><a class="menu-link" href="#">
                                ...
                                <ul class="sub-menu-container">
                                  ...
                                  <li class="menu-item current"><a class="menu-link" href="organisasi.php">
                                    <div>Organisasi</div>
                                </a></li>
			...
			<div class="content-wrap">
				<div class="container">
					<div class="row justify-content-center col-mb-30">
							...
							<h3 class="h1 fw-bold mb-3">Visi dan Misi</h3>
		...
		<section id="content">
			...
			<div class="content-wrap min-vh-20 d-flex align-items-center">
				...
				<div class="container">
					...
					<div class="row col-mb-50 mb-0">
						...
						<div class="col-lg-6">
							...
							<p>Menjadi Rumah Sakit yang terdepan dan terbaik dalam bidang pelayanan, pendidikan, dan penelitian di Provinsi Sulawesi Tengah.</p>
						...
						<div class="col-lg-6">
							...
							<p>
								...
								<ol>
									...
									<li>Meningkatkan Pelayanan Kesehatan yang profesional.</li>

									<li>Melaksanakan Pendidikan, Penelitian, dan Pengabdian Masyarakat di Bidang Kesehatan.</li>

									<li>Meningkatkan Pendapatan Rumah Sakit dan Kesejahteraan Karyawan Rumah Sakit.</li>

									<li>Meningkatkan kerjasama dengan mitra Rumah Sakit.</li>
						...
						<div class="col-lg-6">
							...
							<p>“Mosangu Mosipakabelo artinya bersatu untuk saling memperbaiki dalam upaya peningkatan pelayanan kesehatan masyarakat.”</p>
						...
						<div class="col-lg-6">
							...
							<p>
								...
								<ul>
									...
									<li>Perbaikan mutu pelayanan untuk meningkatkan derajat kesehatan masyarakat</li>

									<li>Perbaikan manajemen dan kapasitas sumber daya manusia</li>

									<li>Pengendalian biaya dan optimalisasi</li>
