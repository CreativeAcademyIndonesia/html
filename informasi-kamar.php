                          ...
                          <nav class="primary-menu style-3 menu-spacing-margin">
                             ...
                             <ul class="menu-container">
                                ...
                                <ul class="sub-menu-container">
                                  ...
                                  <li class="menu-item current"><a class="menu-link" href="informasi-kamar.php">
				...
				<div class="page-title-row">
					...
					<nav aria-label="breadcrumb">
						...
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active" aria-current="page">Informasi Kamar</li>
						</ol>
					</nav>
				</div>
...
<div class="section parallax dark mb-0 border-bottom-0">
					...
					<div class="container">
						...
						<div style="position: relative; margin-bottom: 50px;" data-height-xl="415" data-height-lg="342" data-height-md="262" data-height-sm="160" data-height-xs="102">
							<img src="images/services/chrome.png" style="position: center; top: 0; left: 0;" data-animate="fadeInUp" alt="Chrome">
						</div>


						<div class="heading-block">
							<span style="margin-left: 20px;">Pelayanan Rawat Inap di RSUD UndaProvinsi Sulawesi Tengah, ada 14 ruangan perawatan, dilengkapi dengajumlah tempat tidur sebagai berikut :
							<br><br>
							
							<ul>
								<li>Total Jumlah tempat tidur 270 yang tersebar dengan proporsi</li>
								<li>VIP = 9 tempat tidur</li>
								<li>Kelas 1 = 39 tempat tidur</li>
								<li>Kelas 2 = 28 tempat tidur</li>
								<li>Kelas 3 = 152 tempat tidur</li>
								<li>Isolasi = 42 tempat tidur</li>
								<li>Rawat Khusus = 39 tempat tidur</li>
							</ul>
							</span>
						</div>
						...
						<div class="heading-block">
							<span style="margin-left: 20px;">Ruangan–Ruangan Perawatan Inap yang Ada Meliputi :
							<br><br>
