                ...
                <div class="swiper-container swiper-parent">
                   ...
                   <div class="swiper-wrapper">
                      ...
                      <div class="swiper-slide">
                         ...
                         <div class="swiper-slide-bg"><img src="images/SELAMAT-DATANG-1024x500.png" style="width:100%;height:auto;"></div>
                      ...
                      <div class="swiper-slide">
                      	...
                      	<div class="swiper-slide-bg"><img src="images/Vaksinasi-1-1024x500.png" style="width:100%;height:auto;"></div>
...
<section id="content">
     ...
     <div class="row block-card-9 col-mb-50">
      <div class="col-lg-4 min-vh-75">
         <div class="grid-inner rounded-3 h-100">
            <div class="grid-image lazy" data-bg="images/urologi.jpg"></div>
            <div class="bg-overlay">
               <div class="bg-overlay-content flex-column justify-content-between align-items-start p-5 dark">
                 ...
                 <div class="grid-content">
                     ...
                     <a href="#" class="icon-stacked rounded-circle bg-white text-danger text-center mb-0 btn-hover h5"><i class="bi-arrow-right"></i></a>
                 </div>
             </div>
 ...
 <div class="col-lg-4 min-vh-75">
     <div class="grid-inner rounded-3 h-100">
        <div class="grid-image lazy" data-bg="images/igdposo.png"></div>
        <div class="bg-overlay">
           <div class="bg-overlay-content flex-column justify-content-between align-items-start p-5 dark">
               <div class="grid-icon">
             ...
             <div class="grid-content">
                 <h3 class="fw-medium h2">Ginjal & Hipertensi</h3>
                 <a href="#" class="icon-stacked rounded-circle bg-white text-center mb-0 btn-hover h5" style="color: brown"><i class="bi-arrow-right"></i></a>
             </div>
         </div>
 ...
 <div class="grid-inner rounded-3 h-100">
    ...
    <div class="bg-overlay">
       <div class="bg-overlay-content flex-column justify-content-between align-items-start p-5 dark">
         ...
         <div class="grid-content">
             <h3 class="fw-medium h2">Jantung</h3>
             <a href="#" class="icon-stacked rounded-circle bg-white text-success text-center mb-0 btn-hover h5"><i class="bi-arrow-right"></i></a>
         </div>
     </div>
     <div class="bg-overlay-bg" style="background: linear-gradient(to bottom, rgba(0,0,0,0.3) 0%, #497b37 100%);"></div>
		...
		<section id="content">
          ...
          <div class="col-xl-6 col-lg-8 text-center">
             <h3 class="h1 fw-bold mb-3">Informasi Pasien</h3>
         </div>
...
<section id="content">
 ...
 <div class="content-wrap">
    ...
    <div class="container">
       <div class="row justify-content-center mb-5">
          <div class="col-xl-6 col-lg-8 text-center">
             <h3 class="h1 fw-bold mb-3">Data Dokter Kami</h3>
         </div>
     </div>
         ...
         <div class="team-person">
            <div class="person-container">
               <div class="person-container-inner">
                  <img class="person-circle" src="images/dok-1.png">
                  <img class="person-img" src="images/dok-1.png">
              </div>
          </div>
          <div class="person-divider bg-danger"></div>
          <div class="fs-4 fw-semibold mb-1 mt-4 text-black">Brian Cumin</div>
          <div class="text-black-50 text-smaller">Product Manager</div>
      </div>
  </div>
  <div class="col-auto">
     <div class="team-person">
        <div class="person-container">
           <div class="person-container-inner">
              <img class="person-circle" src="images/dok-2.png">
              <img class="person-img" src="images/dok-2.png">
          </div>
      </div>
      <div class="person-divider bg-primary"></div>
      <div class="fs-4 fw-semibold mb-1 mt-4 text-black">Ravi O'Leigh</div>
      <div class="text-black-50 text-smaller">Product Manager</div>
  </div>
</div>
<div class="col-auto">
 <div class="team-person">
  ...
  <div class="person-divider bg-success"></div>
  <div class="fs-4 fw-semibold mb-1 mt-4 text-black">Jackson Pot</div>
  <div class="text-black-50 text-smaller">Product Manager</div>
</div>
</div>
</div>
...
<section id="content">
  <div class="content-wrap">
     <div class="container">
        <div class="row justify-content-center mb-5">
           <div class="col-xl-6 col-lg-8 text-center">
              <h3 class="h1 fw-bold mb-3">Link</h3>
          </div>
      </div>
				...
				<div class="container mw-md">
					<div class="row align-items-stretch grid-border">
						<div class="col-md-6 col-padding">
									...
									<h3 class="text-transform-none ls-0 text-larger mt-3 text-center">Akreditasi Versi SNARS Edisi 1 Tk Utama
									<br>Nomor KARS -Sert/499/V/2019</h3>
						</div>
						<div class="col-md-6 col-padding">
