				...
				<div class="container">
					...
					<div class="header-row">
                      ...
                      <ul class="sub-menu-container">
                          ...
                          <li class="menu-item current"><a class="menu-link" href="dokter.php">
                            <div>Dokter</div>
                        </a></li>
				...
				<div class="container">
					<div class="row justify-content-center mb-0">
						<div class="col-xl-6 col-lg-8 text-center">
							<h3 class="h1 fw-bold mb-3">Info Dokter di RSUD Kabposo</h3>
						</div>
					</div>
					...
					<div class="row justify-content-center mb-5">
						<div class="col-xl-6 col-lg-8 text-center">
							<br><br>
							<h3 class="h3 fw-bold mb-3">Kelompok Staf Medik (KSM) di RSUD Kabposo</h3>
						</div>
					</div>
						<div class="row justify-content-center mb-5">
						    <div class="text-center">
						        <img src="images/services/chrome.png">
						    </div>
					</div>
